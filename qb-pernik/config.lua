...
Config.CircleZones = {
	PervitinField = {coords = vector3(3728.7, 3805.07, 5.57), name = 'blip_PickupPernik', color = 25, sprite = 496, radius = 30.0},
	PervitinProcessing = {coords = vector3(2433.94, 4968.69, 42.35), name = 'blip_ProcessPernik', color = 25, sprite = 496, radius = 100.0},
